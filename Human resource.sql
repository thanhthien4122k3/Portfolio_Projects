...
-- 2. What is the race/ehtnicity breakdown of employees in the company?
SELECT 
    race, COUNT(*) AS count
FROM
    hr
...
-- 3. What is the age distribution of emlployees in the company?
SELECT 
...
-- 8. Which department has the highest the turnover rate?
SELECT 
    department,
    total_count,
    terminated_count,
...
-- 10. How has the company's employee count changed over time based to hire and term dates?
SELECT 
    year,
    hires,
    terminations,
